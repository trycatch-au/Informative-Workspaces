...
use NDM\TryCatchBundle\Form\PlannedReleaseDateType;
...
class PlannedReleaseDateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NDMTryCatchBundle:PlannedReleaseDate')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NDMTryCatchBundle:PlannedReleaseDate')->find($id);
     ...
     * @Method("post")
     * @Template("NDMTryCatchBundle:PlannedReleaseDate:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("NDMTryCatchBundle:PlannedReleaseDate:edit.html.twig")
     */
