...
namespace NDM\Bundle\TryCatch\ApiBundle\Tests\Ingester\Writer;
...
class MapWriterTest extends \PHPUnit_Framework_TestCase {
	...
	public function testBasicWrite() {
		$colMock = $this->getMock('NDM\Bundle\TryCatch\ApiBundle\Ingester\Map\ColumnDefinition', array(), array('created_at', 'createdAt'));
	...
	public function testFilteredWrite() {
		...
		$filterMock = $this->getMock('NDM\Bundle\TryCatch\ApiBundle\Ingester\Map\Transformer\Transformer');
